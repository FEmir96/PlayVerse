...
export default function ExtendRentalPage() {
  ...
  const newExpiryDate = new Date("2025-07-20")
  newExpiryDate.setDate(newExpiryDate.getDate() + weeks[0] * 7)

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Handle extension logic here
    console.log("Processing extension:", { ...formData, weeks: weeks[0], totalPrice })
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-orange-400 mb-2">Extender alquiler</h1>
            <p className="text-slate-400">Estas extendiendo:</p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-700/30 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-teal-400 mb-2">Tu alquiler actual:</h3>
                  <div className="text-sm text-slate-300 mb-1">
                    <span className="text-teal-400">Válido hasta el {gameData.currentExpiry}</span>
                  </div>
                  <div className="text-2xl font-bold text-purple-400 mb-2">${gameData.weeklyPrice}/sem</div>
