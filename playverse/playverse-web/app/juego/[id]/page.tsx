    ...
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-2 gap-8">
              ...
              {gameData.images.map((image, index) => (
                <button
                  ...
                  className={`aspect-video rounded-lg overflow-hidden border-2 transition-colors ${
                    selectedImageIndex === index ? "border-orange-400" : "border-slate-600"
                  }`}
                >
                  <Image
          ...
          {/* Right Column - Game Info and Actions */}
            ...
            <div className="bg-slate-800/50 border border-orange-400/30 rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <svg
                      className={`w-4 h-4 mr-2 ${isFavorite ? "fill-current" : "stroke-current fill-none"}`}
                      viewBox="0 0 20 20"
                    >
                      <path
                        strokeLinecap="round"
        ...
        <div className="mt-8 grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-cyan-500 to-purple-600 rounded-lg p-6 text-center">
              ...
              <Link href="/premium">
                <Button className="bg-white text-purple-600 hover:bg-slate-100 font-semibold">Descubre premium</Button>
              </Link>
            </div>
          </div>
        </div>
