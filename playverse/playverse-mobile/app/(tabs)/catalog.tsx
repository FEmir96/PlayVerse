...
export default function CatalogScreen() {
  ...
  // Datos de ejemplo para los juegos del catálogo (más juegos para probar la paginación)
  const allCatalogGames = [
    {
      id: '1',
      title: 'Tomb Raider',
      genre: 'Acción',
  ...
  const filteredGames = allCatalogGames.filter(game => {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        >
            <View style={styles.titleSection}>
              <Text style={[styles.title, { color: colors.secondary }]}>CATÁLOGO DE JUEGOS</Text>
              <Text style={[styles.subtitle, { color: colors.white }]}>
                ¡Sumérgete en el PlayVerse! Encuentra tu próxima obsesión entre nuestra vasta colección de títulos retro y modernos.
              </Text>
            </View>
